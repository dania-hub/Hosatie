...
class CreateInternalSupplyRequestItemTable extends Migration
{
    public function up()
    {
        Schema::create('internal_supply_request_item', function (Blueprint $table) {
            ...
            $table->foreign('request_id')->references('id')->on('internal_supply_request')->onDelete('cascade');
    ...
    {
        Schema::dropIfExists('internal_supply_request_item');
    }
}
