                    ...
                    <div class="space-y-3">
                        ...
                        <div class="flex justify-end gap-2 pt-2">
                            <button
                                ...
                                class="px-4 py-2 text-sm rounded-[30px] font-medium text-gray-700 dark:text-gray-300 bg-gray-200 dark:bg-gray-700 hover:bg-gray-300 dark:hover:bg-gray-600 transition duration-200"
                            ...
                            <button
                                ...
                                class="px-4 py-2 text-sm rounded-[30px] font-medium text-white bg-red-600 hover:bg-red-700 dark:bg-red-700 dark:hover:bg-red-800 transition duration-200 flex items-center"
                                :disabled="isConfirming"
                            >
                                <Icon v-if="isConfirming" icon="eos-icons:loading" class="w-4 h-4 ml-2 animate-spin" />
                                <Icon v-else icon="tabler:check" class="w-4 h-4 ml-2" />
                                تأكيد الرفض
                            </button>
                        </div>
                    </div>
            ...
            >
                ...
                <div class="flex gap-3 w-full sm:w-auto">
                    <button
                        ...
                        class="inline-flex items-center px-[11px] py-[9px] border-2 border-[#ffffff8d] h-12 w-35 rounded-[30px] transition-all duration-200 ease-in relative overflow-hidden text-[15px] cursor-pointer text-white z-[1] bg-[#90685e] hover:border hover:border-[#a8a8a8] hover:bg-[#90685ee0]"
