            ...
            <div class="p-8 space-y-8">
                ...
                <div class="bg-white p-6 rounded-2xl shadow-sm border border-gray-100">
                    ...
                    <div class="grid grid-cols-1 sm:grid-cols-2 gap-6">
                        ...
                        <div class="space-y-2 sm:col-span-2">
                            <Label class="text-gray-500 font-medium">المستشفى</Label>
                            <div class="p-3 bg-gray-50 rounded-xl border border-gray-100 font-bold text-[#2E5077]">
                ...
                <div class="bg-white p-6 rounded-2xl shadow-sm border border-gray-100">
                    ...
                    <div class="grid grid-cols-1 sm:grid-cols-2 gap-6">
                        ...
                        <div class="space-y-2">
                            <Label class="text-gray-500 font-medium">تاريخ الإنشاء</Label>
                            <div class="p-3 bg-gray-50 rounded-xl border border-gray-100 font-bold text-[#2E5077] font-mono">
                                {{ patient.createdAt ? formatDateForDisplay(patient.createdAt) : 'غير محدد' }}
                            </div>
                        </div>

                        <div class="space-y-2">
                            <Label class="text-gray-500 font-medium">آخر تحديث</Label>
                            <div class="p-3 bg-gray-50 rounded-xl border border-gray-100 font-bold text-[#2E5077] font-mono">
                                {{ patient.lastUpdated ? formatDateForDisplay(patient.lastUpdated) : 'غير محدد' }}
                            </div>
                        </div>
