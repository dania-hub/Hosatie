...
const validateForm = () => {
    ...
    errors.value.type = !data.type;
    if (errors.value.type) isValid = false;
        ...
        >
            ...
            <form @submit.prevent="submitForm" class="p-8 space-y-8">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <!-- نوع المستشفى -->
                    <div class="space-y-2">
                        <Label for="type" class="text-sm font-semibold text-[#2E5077] flex items-center gap-2">
                        ...
                        <div class="relative">
                            <select
                                id="type"
                                v-model="form.type"
                                :class="{ 'border-red-500 focus:ring-red-500/20': errors.type, 'border-gray-200 focus:border-[#4DA1A9] focus:ring-[#4DA1A9]/20': !errors.type }"
                        ...
                        <p v-if="errors.type" class="text-xs text-red-500 flex items-center gap-1">
                            <Icon icon="solar:danger-circle-bold" class="w-3 h-3" />
                            الرجاء اختيار نوع المؤسسة الصحية
                        </p>
                    </div>
                    ...
                    <div class="space-y-2">
                        ...
                        <div class="relative">
                            <Input
                                ...
                                type="text"
                                :class="{ 'border-red-500 focus:ring-red-500/20': errors.address, 'border-gray-200 focus:border-[#4DA1A9] focus:ring-[#4DA1A9]/20': !errors.address }"
                                class="bg-white border-gray-200 focus:border-[#4DA1A9] focus:ring-[#4DA1A9]/20"
                            />
                        </div>
                        <p v-if="errors.city" class="text-xs text-red-500 flex items-center gap-1">
