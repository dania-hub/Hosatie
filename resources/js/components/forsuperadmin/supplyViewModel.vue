                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        <div class="md:col-span-2 space-y-4 p-4 rounded-xl">
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                                ...
                                <div class="space-y-2">
                                    ...
                                    <div class="bg-white border border-gray-200 rounded-xl p-3 text-[#2E5077] font-bold h-10 flex items-center">
                                        {{ supplier.admin?.name || supplier.managerName || 'غير محدد' }}
                                    </div>
                                </div>
                                ...
                                <div class="space-y-2">
                                    ...
                                    <div class="bg-white border border-gray-200 rounded-xl p-3 text-[#2E5077] font-mono h-10 flex items-center">
                                        {{ supplier.admin?.email || 'لا يوجد' }}
                                    </div>
                                </div>
                    ...
                    <div class="space-y-2">
                        ...
                        <div class="flex items-center h-10">
                            ...
                            >
                                <Icon :icon="supplier.isActive ? 'solar:check-circle-bold' : 'solar:close-circle-bold'" class="w-5 h-5" />
