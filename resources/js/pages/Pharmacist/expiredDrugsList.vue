...
const fetchExpiredDrugs = async () => {
  ...
  try {
    ...
    expiredDrugs.value = [];
    hasData.value = false;
    error.value = "تعذر تحميل قائمة الأدوية المُصفرة.";
  } finally {
...
`;
  ...
  printWindow.document.write("<html><head><title>طباعة الأدوية المُصفرة</title>");
                    ...
                    >
                        ...
                        >
                            <button
                                ...
                                @click="router.visit('/pharmacist/medications')"
                            >
